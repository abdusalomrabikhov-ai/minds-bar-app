...
- Если менялся CSS **или JS** в `public/` — бампнуть `?v=N` в `index.html` для соответствующего файла (кэш-бастинг, assets кэшируются `immutable` на год). Текущие версии: `style.min.css?v=38`, `app.min.js?v=23`
